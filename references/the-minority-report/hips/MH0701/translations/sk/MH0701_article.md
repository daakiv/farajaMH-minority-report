...
### Impacts  
Rogue waves have destructive effects on ships and offshore structures and activities. A review of ship accident reports showed several vulnerabilities to damage from rogue waves. In various rogue wave‑related ship accident cases, “the wave smashed bridge windows and flooded instrument panels, disabling critical instruments and, in a number of cases, caused a complete loss of power” (Gasparotti & Rusu, 2016). Rogue waves can also impact and, in some cases, lead to the destruction of “offshore wind farms or wave energy farms operating in the coastal environment” (Gasparotti & Rusu, 2016). These impacts highlight the importance of accounting for meteorological (temperature, pressure and wind) and oceanographic conditions (waves, current) in ship and offshore standards in order to ensure marine safety (Gasparotti & Rusu, 2016).  
...
- National, sub‑national, and local disaster management agencies responsible for monitoring rogue wave risks, issuing warnings, and coordinating emergency response for maritime safety.  
- Meteorological and oceanographic services tracking wind patterns, storm activity, and ocean currents that contribute to rogue wave formation.  
- Marine and hydrological research institutions studying ocean wave dynamics, wave height variability, and rogue wave occurrences.  
- Geophysical and atmospheric research agencies analysing interactions between the atmosphere and ocean, such as pressure systems and extreme weather events, that influence rogue waves.  
- Naval and maritime safety authorities monitoring sea conditions and issuing alerts to ships, offshore platforms, and coastal communities.  
- Remote sensing agencies using satellites, radar altimeters, and ocean buoys to detect sudden changes in wave height and sea state.  
- Energy and offshore industries assessing risks to oil rigs, offshore wind farms, and underwater infrastructure from extreme wave events.  
- Shipping and maritime industries using wave prediction models and navigational tools to minimise risks to vessels and cargo transport.  
- Researchers and academics, including oceanographers and climate scientists, studying rogue wave formation, prediction models, and climate change impacts on wave patterns.  
- Coastal communities and fishing industries engaged in monitoring sea conditions, adapting to changing wave patterns, and enhancing maritime safety.  
